...
export default class DashBoard extends Component {
  ...
  renderDrawer() {
    ...
    const mT = marginTop; // marginTop  of the middle of the circle    const cDiam = (width + height) - (mL + mT); // circle diameter
